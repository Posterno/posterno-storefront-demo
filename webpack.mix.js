 ...
 *
 * @package   PosternoStorefrontDemo
 * @author    Pressmodo
 * @copyright 2019 Pressmodo
...
mix.webpackConfig( {
	...
	resolve     : {
		alias : {
			// Alias for Sanity Customize assets.
			// Import from `sanity-customize/js` or `~sanity-customize/scss`.
			// 'sanity-customize' : path.resolve( __dirname, 'vendor/justintadlock/sanity-customize/resources/' )
		}
	},
	plugins     : [
